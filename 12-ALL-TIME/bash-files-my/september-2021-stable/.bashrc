...
function fileSize {
    for filesize in $(ls -l . | grep "^-" | awk '{print $5}'); do
...
if [ "$(id -u)" -eq 0 ]; then
    PS1="user->\[\033[m\]|\[\e[1;31m\]\u\[\e[1;36m\]\[\033[m\] \n\W_exitstatus:\$?\[$(tput sgr0)\][\033[00m\]  =========]0->\n\n\n\n"
else
    PS1="user->\[\033[m\]|\[\e[1m\]\u\[\e[1;36m\]\nDirectory\[\033[m\]\[\e[1;32m\][\W] \n\W_Exitstatus:  [\[\033[1;31m\]\$?]\n\[$(tput sgr0)]\[\033[00m\]\n\[\033[1;31m\]0utput0==================================================0->\n\n"
fi
